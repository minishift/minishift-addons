...
<6> Enable the Minishift `anyuid` add-on.  For more details on OpenShift SCC, see link:https://docs.okd.io/latest/admin_guide/manage_scc.html[Managing Security Context Constraints]
