...
- The add-on uses Istio Operator v0.9.0
- This add-on depends on admin-user and anyuid  Minishift addons
====

== Minishift profile setup

As this Istio setup deploys applications like "3scale-istio-adapter", "istio-citadel", "istio-policy", "istio-sidecar-injector", "istio-telemetry", *istio-galley*,*istio-ingressgateway*, *istio-egressgateway*, *istio-pilot*,*elasticsearch*,*jaeger**,*kiali*, *grafana*, *prometheus* with their related resources
